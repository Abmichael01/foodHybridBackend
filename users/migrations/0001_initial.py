    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('admin', 'Admin'), ('vendor', 'Vendor'), ('partner', 'Partner')], default='', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_type', models.CharField(choices=[('fund', 'Funding'), ('withdraw', 'Withdrawal'), ('investment', 'Investment'), ('roi', 'Return On Investment'), ('system', 'System Notification'), ('admin', 'System Admin Notification'), ('order', 'order delivered')], default='system', max_length=50)),
