...
urlpatterns = [
    ...
    path("admin/remittance/<str:remittance_id>/confirm/", AdminConfirmRemittanceView.as_view(), name="admin-confirm-remittance"),
    path("remittance/", VendorRemitView.as_view(), name="create-remittance"),
    path("vendor/beneficiaries/", BeneficiaryListCreateView.as_view(), name="beneficiary-list-create"),
